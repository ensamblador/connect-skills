...
Run:
    uv run python .kiro/scripts/refresh_connect_ai_agents.py            # write
    uv run python .kiro/scripts/refresh_connect_ai_agents.py --dry-run  # preview
    uv run python .kiro/scripts/refresh_connect_ai_agents.py --check    # exit non-zero on drift, don't write
"""
