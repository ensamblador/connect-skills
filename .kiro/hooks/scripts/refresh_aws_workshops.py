...
``.kiro/hooks/scripts/refresh_connect_views.py``) to render each page, then
extract:
...
Run:
    uv run python .kiro/hooks/scripts/refresh_aws_workshops.py            # write
    uv run python .kiro/hooks/scripts/refresh_aws_workshops.py --dry-run  # preview
    uv run python .kiro/hooks/scripts/refresh_aws_workshops.py --only fundamentals
