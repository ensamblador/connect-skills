...
Run:
    uv run python .kiro/hooks/scripts/refresh_connect_views.py            # write (no props)
    uv run python .kiro/hooks/scripts/refresh_connect_views.py --dry-run  # preview
    uv run python .kiro/hooks/scripts/refresh_connect_views.py --with-props
...
``uv run python .kiro/hooks/scripts/refresh_connect_views.py`` from two upstream
sources:
...
``uv run python .kiro/hooks/scripts/refresh_connect_views.py`` to refresh it
